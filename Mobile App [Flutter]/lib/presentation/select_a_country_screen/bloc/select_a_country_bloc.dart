...
import 'package:fotisia/presentation/select_a_country_screen/models/select_a_country_model.dart';
part 'select_a_country_event.dart';
part 'select_a_country_state.dart';

/// A bloc that manages the state of a SelectACountry according to the event that is dispatched to it.
class SelectACountryBloc
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        searchController: TextEditingController(), radioGroup: ""));
    emit(state.copyWith(
        selectACountryModelObj: state.selectACountryModelObj
