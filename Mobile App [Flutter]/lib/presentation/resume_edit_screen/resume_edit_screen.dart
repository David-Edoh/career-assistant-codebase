...
class ResumeEditScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: CustomAppBar(
            ...
            leading: Semantics(
              label: "button: Back to previous screen",
              child: AppbarImage(
                  ...
                  child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            Center(
                              child: Semantics(
                                label: "button: Your professional photo, to be added to your resume",
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, firstNameController) {
                                  return Semantics(
                                    label: "Input field: Edit your first name",
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, lastNameController) {
                                  return Semantics(
                                    label: "Input field: Edit your last name",
                                    child: CustomTextFormField(
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, preferredDesignationController) {
                                  return Semantics(
                                    label: "Input field: Edit your preferred career title",
                                    child: CustomTextFormField(
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, emailController) {
                                  return Semantics(
                                    label: "Input field: Edit your email address",
                                    child: CustomTextFormField(
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, phoneController) {
                                  return Semantics(
                                    label: "Input field: Edit / add your phone number.",
                                    child: CustomTextFormField(
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, websiteController) {
                                  return Semantics(
                                    label: "Input field: Add / Edit your website url if you have a website.",
                                    child: CustomTextFormField(
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, aboutMeController) {
                                  return Semantics(
                                    label: "Input field: Edit about me section.",
                                    child: CustomTextFormField(
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, locationController) {
                                  return Semantics(
                                    label: "Input field: Add / Edit your physical address.",
                                    child: CustomTextFormField(
                            ...
                            BlocSelector<ResumeEditBloc,
                                ...
                                builder: (context, skillsController) {
                                  return Semantics(
                                    label: "Input field: Add / edit your professional skills. Separate each skill with a comma.}",
                                    child: TextFieldTags(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      // crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          ...
                                                          // BlocProvider(
                                                          //   create: (context) => BlocProvider.of<ResumeEditBloc>(context),
                                                          //   child: YourWidget(),
                                                          // ),
                                                    ...
                                                    // crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        ...
                                                        CustomIconButton(
                                                          ...
                                                          onTap: ()  async {
                                                            context.read<ResumeEditBloc>().add(
                                                              TempSaveResumeDetailsEvent(),
                                                            );
                                                            const storage = FlutterSecureStorage();
                                                            await storage.write(key: "itemId", value: education.id.toString());
                                                            NavigatorService.pushNamed(AppRoutes.addNewEducationScreen).then((_) {
                                                              context.read<ResumeEditBloc>().add(ResumeEditInitialEvent());
                                                            });
                                                          },
                                                          child: CustomImageView(
                                                            svgPath: ImageConstant
                                                        ...
                                                        children: [
                                                          ...
                                                          CustomIconButton(
                                                            ...
                                                            onTap: ()  async {
                                                              ...
                                                              NavigatorService.pushNamed(AppRoutes.addNewProjectScreen).then((_) {
                                                                context.read<ResumeEditBloc>().add(ResumeEditInitialEvent());
                                                              });
                                                            },
                                                            child: CustomImageView(
                            ...
                            Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      state.certifications != null && state.certifications!.isNotEmpty ? Column(
                                          children: state.certifications!.map((certification) {
                                            return Builder(
                                              builder: (BuildContext context1) {
                                                return Padding(
                                                    padding:
                                                        ...
                                                        children: [
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                            ...
                                                                            getPadding(
                                                                                top: 6),
                                                                            child: Text(
                                                                                "${certification.startDate.toString()} - ${certification.endDate.toString()}",
                                                                                style: theme
                                                                                    .textTheme
                                                                                    .labelLarge)
                                                                        )
                                                          ...
                                                          CustomIconButton(
                                                            ...
                                                            onTap: ()  async {
                                                              ...
                                                              const storage = FlutterSecureStorage();
                                                              await storage.write(key: "itemId", value: certification.id.toString());
                                                              NavigatorService.pushNamed(AppRoutes.addNewCertificationScreen).then((_) {
                                                                context.read<ResumeEditBloc>().add(ResumeEditInitialEvent());
                                                              });
                                                            },
                                                            child: CustomImageView(
                                        ...
                                        child: Text(
                                          "Please add a Training, Course or Certification",
                                        ),
                                      )
                                    ]
                                )
                                                      ...
                                                      children: [
                                                        ...
                                                        CustomIconButton(
                                                          ...
                                                          onTap: ()  async {
                                                            ...
                                                            NavigatorService.pushNamed(AppRoutes.addNewReferenceScreen).then((_) {
                                                              context.read<ResumeEditBloc>().add(ResumeEditInitialEvent());
                                                            });
                                                          },
                                                          child: CustomImageView(
                                                      ...
                                                      children: [
                                                        ...
                                                        CustomIconButton(
                                                          ...
                                                          onTap: ()  async {
                                                            ...
                                                            NavigatorService.pushNamed(AppRoutes.addNewSocialLinkScreen).then((_) {
                                                              context.read<ResumeEditBloc>().add(ResumeEditInitialEvent());
                                                            });;
                                                          },
                                                          child: CustomImageView(
 ...
 Future<void> uploadProfilePic(BuildContext context) async {
  ...
  // onTapImgEditsquareone(BuildContext context) async {
  //   await NavigatorService.popAndPushNamed(
