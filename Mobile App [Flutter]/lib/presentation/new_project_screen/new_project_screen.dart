...
class NewProjectScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NewProjectBloc>(
        create: (context) => NewProjectBloc(
            NewProjectState(newProjectModelObj: NewProjectModel()))
          ..add(NewProjectInitialEvent()),
                      ...
                      child: Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                BlocSelector<NewProjectBloc, NewProjectState,
                                        TextEditingController?>(
                                    selector: (state) => state.projectTitleController,
                                    builder: (context, projectTitleController) {
                                      return Semantics(
                                        label: "Add / Edit project name field",
                                        child: CustomTextFormField(
                                            controller: projectTitleController,
                                            margin: getMargin(top: 9),
                                            hintText: "e.g Capstone project",
                                ...
                                BlocSelector<NewProjectBloc, NewProjectState,
                                        TextEditingController?>(
                                    selector: (state) =>
                                        state.projectDescriptionController,
                                    builder:
                                        (context, projectDescriptionController) {
                                      return Semantics(
                                        label: "Add / Edit project description field",
                                        child: CustomTextFormField(
  ...
  Future<void> onTapSelectdate(BuildContext context) async {
    var initialState = BlocProvider.of<NewProjectBloc>(context).state;
