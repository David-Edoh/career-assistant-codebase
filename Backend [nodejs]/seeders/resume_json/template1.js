...
#disclaimer code{
  ...
  font-style: normal;
      ...
      <body lang="en" class="A4" >
        <div class="container sheet" style="width: 211mm; height: max-content !important; min-height: 289mm; position: relative; margin: auto; padding-bottom: 45px;">
          <section id="main">
            <header id="title">
              <h1>{{first_name}} {{last_name}}</h1>
              <span class="subtitle">{{about_me}}</span>
            </header>
            {{experience_section}}
            {{project_section}}
            {{education_section}}
          ...
          <aside id="sidebar" style="position: absolute; right: 0px; padding-bottom: unset;">
  ...
  sampleHTML: `<!DOCTYPE html>
    ...
    *{
    ...
    #disclaimer code{
      ...
      <body lang="en" class="A4" >
        <div class="container sheet" style="width: 211mm; height: 297mm;">
          <section id="main">
            <header id="title">
              <h1>John Doe</h1>
  ...
  experienceHTML: `<section class="blocks">
    <div class="date">
      <span>{{experience_start_year}}</span><span>{{experience_end_year}}</span>
    </div>
    <div class="decorator">
    </div>
    <div class="details">
      <header>
        <h3>{{position}}</h3>
        <span class="place">{{company_name}}</span>
        <span class="location"><span class="location"><i class="fa fa-map-marker" style="margin-right: 5px;"></i>{{company_address}}</span>
      </header>
      <div>
        <ul>
            {{description}}
  ...
  educationHTML: `<section class="blocks">
    <div class="date">
      <span>{{education_start_year}}</span><span>{{education_end_year}}</span>
    </div>
    <div class="decorator">
    </div>
    <div class="details">
      <header>
        <h3>{{education_level}} in {{discipline}}</h3>
        <span class="place">{{school_name}}</span>
        <span class="location">{{school_address}}</span>
      </header>
      <div>{{education_description}}</div>
    </div>
  </section>`,
  skillHTML: `<li>{{skill}}</li>`,
  socialsHTML: `<li><i class="fa fa-link"></i> {{social_link}}</li>`,
  projectsHTML: `<section class="blocks">
    <div class="date">
      <span>{{project_start_year}}</span><span>{{project_end_year}}</span>
    </div>
    <div class="decorator">
    </div>
    <div class="details">
  ...
  certificationsHTML: `<section class="blocks">
  <div class="date">
    <span>{{certification_start_year}}</span><span>{{certification_end_year}}</span>
  </div>
  <div class="decorator">
  </div>
  <div class="details">
    <header>
      <h3>{{certification_title}}</h3>
      <!---<span class="place">Some workplace</span>--->
    </header>
    <div>
  ...
  experienceSection: `<section class="main-block">
              <h2>
                <i class="fa fa-suitcase"></i> Experiences
              </h2>
              {{experience_list}}
            </section>`,
  educationSection: `<section class="main-block concise">
    <h2>
      <i class="fa fa-graduation-cap"></i> Education
    </h2>
    {{education_list}}
  </section>`,
  projectSection: `<section class="main-block">
    <h2>
      <i class="fa fa-folder-open"></i> Selected Projects
    </h2>
    {{projects_list}}
  </section>`,
  certificationSection: `<section class="main-block">
  <h2>
    <i class="fa fa-folder-open"></i> TRAINING / COURSES / CERTIFICATIONS
  </h2>
  {{certifications_list}}
</section>`,
  skillsSection: `<div class="side-block" id="skills">
    <h1>
      Skills
    </h1>
    <ul>
  ...
  phoneNumberSection: `<li><i class="fa fa-phone"></i> {{phone_number}}</li>`,
  websiteSection: `<li><i class="fa fa-globe"></i> {{website}}</li>`,
  // referenceSection: ``,
  // profilePicSection: ``,
  // socialsSection: ``,
