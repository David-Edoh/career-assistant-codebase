                                ...
                                children: [
                                  ...
                                  widget.listlogoOneItemModelObj.post?.userId == state.thisUser?.id ? PopupMenuButton<int>(
                                    ...
                                    itemBuilder: (context) => [
                                      ...
                                      PopupMenuItem(
                                        onTap: (){
                                          context.read<SinglePostBloc>().add(DeletePostEvent(postId: widget.listlogoOneItemModelObj.post?.id));
                                        },
                                        value: 1,
                            ...
                            child: HeartButton(context2: context, postId: int.parse(widget.listlogoOneItemModelObj!.id.toString()),
                                ...
                                getUpdatedPost: () async {
                                  ...
                                  await _apiClient.getData(
                                    ...
                                    context.read<SinglePostBloc>().add(UpdatePostEvent(posts: widget.listlogoOneItemModelObj!.posts!));
