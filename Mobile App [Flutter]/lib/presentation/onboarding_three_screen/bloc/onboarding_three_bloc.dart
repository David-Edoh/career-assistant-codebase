...
import 'package:fotisia/presentation/onboarding_three_screen/models/onboarding_three_model.dart';
...
class OnboardingThreeBloc
  ...
  List<SliderapplicatiItemModel> fillSliderapplicatiItemList() {
    return List.generate(1, (index) => SliderapplicatiItemModel());
  }
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        onboardingThreeModelObj: state.onboardingThreeModelObj?.copyWith(
            sliderapplicatiItemList: fillSliderapplicatiItemList())));
  }
}
