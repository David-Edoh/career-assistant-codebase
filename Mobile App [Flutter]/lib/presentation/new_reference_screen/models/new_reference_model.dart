...
class NewReferenceModel extends Equatable {
  NewReferenceModel({this.dropdownItemList = const []});

  List<SelectionPopupModel> dropdownItemList;

  NewReferenceModel copyWith({List<SelectionPopupModel>? dropdownItemList}) {
