...
/// This class draws the arrow and hamburger shapes.
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    // Calculate the points for the first line of the hamburger/arrow icon
    ...
    // Calculate the points for the second line of the hamburger/arrow icon
    ...
    // Define the paint properties for the lines
    final paint = Paint()
      ..color = iconColor
      ..strokeCap = StrokeCap.round
      ..strokeWidth = iconHeight * .08;
